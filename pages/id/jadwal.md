...
title: Jadwal
description: Jadwal Kuliah Kelas 3A Informatika
---

# Jadwal Kuliah — Kelas 3A Informatika

Jadwal perkuliahan **Kelas 3A Informatika** beserta informasi waktu perkuliahan dan denah lokasi ruang kelas.
...
<div style="display: flex; gap: 24px; align-items: flex-start; width: 100%;">
  ...
  <div style="flex: 7; min-width: 0;">
    <h3>Denah Kampus</h3>
    <p>Lokasi ruang kelas berdasarkan denah kampus:</p>
    <img
      src="/Jadwal/denah_kampus.png"
      alt="Denah Kampus"
  ...
  <div style="flex: 3; min-width: 0;">
    <h3>Jam Mata Kuliah</h3>
    <p>Ketentuan jam perkuliahan yang berlaku:</p>
    <img
      src="/Jadwal/jam_matkul.png"
      alt="Jam Mata Kuliah"
      style="display: block; width: 100%; height: auto;"
    >
  </div>
